...
<body>
    <div class="card">
        <div class="card-header">
            <h1>NOM:035 <?php echo e($periodo); ?></h1>
        </div>
        <div class="card-body">
            <p>Se han asignado las fechas para la realización semestral de la <b>NOM:035</b></p>
            <p>la cual dará inicio este <b><?php echo e($fechas['fechaInicio']); ?></b> y finalizará el <b><?php echo e($fechas['fechaLimite']); ?></b> </p>
            <p>La plataforma destinada a este uso, permitirá resolver la Norma durante las fechas previamente mencionadas</p>
            <p><a href="<?php echo e(route('home')); ?>">Acceso a la Plataforma de realización</a></p>
...
</html><?php /**PATH C:\xampp\htdocs\Laravel\New testlaboral\resources\views/cuestionario/email/notificaion-asignacion.blade.php ENDPATH**/ ?>